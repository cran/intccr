...
#' @details The function \code{bssmle_aipw_se} estimates bootstrap standard errors for the estimated regression coefficients from the function \code{bssmle}.
#' @return The function \code{bssmle_aipw_se} returns a list of components:
